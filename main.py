...
###################################################################
    ...
    def open(self, args_str, type):
        ...
        storage.child(f"{args_str}/{args_str}_{type}.png").download("/assets/dl_qr/",f"{args_str}_{type}.png")
...
###################################################################
    ...
    def upload(self):
        ...
        watermark = self.help.get_screen('uploaddoc').ids.input_12.text
        ...
        if image == "":
            ...
            texty = f" © {watermark}, {self.current_year} | Philippine Nuclear Research Institute"
            ...
            # im.show()
            im.save(f'assets/captured_img/{name}_image.png')

            storage.child(
                f"{name}/{name}_image.png").put(f'assets/captured_img/{name}_image.png')
